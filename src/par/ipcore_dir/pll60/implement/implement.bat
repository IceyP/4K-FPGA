...
xst -ifn xst.scr
move pll60_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll60_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll60_exdes.ucf pll60_exdes

echo 'Running map'
map -timing -pr b pll60_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pll60_exdes -w routed.ncd routed.v
cd ..
